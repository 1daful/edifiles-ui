...
import { ArgumentNode, FieldNode, IntValueNode, OperationDefinitionNode, SelectionNode, parse } from "graphql";
import { Operation } from "@urql/vue";
import { Argument, Selection } from "../utils/types";
