...
<<<<<<< HEAD
        this.axiosClient.interceptors.response.use(undefined, (error) => {
            ...
            if ("response" in error) {
                ...
                throw new _1.GorseException(response.status, response.data);
            }
            // Network errors
            throw new _1.GorseException(-1, error.message);
        });
=======
>>>>>>> origin/main
    }
...
<<<<<<< HEAD
    getSessionRecommend(feedbackList, options = {}) {
        return (0, recommend_1.getSessionRecommend)(this.axiosClient, feedbackList, options);
    }
=======
>>>>>>> origin/main
    // Feedback
